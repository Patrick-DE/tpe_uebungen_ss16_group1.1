...
public class ThreadedQuicksort implements SortAlgorithm{


	private static int threadCounter = 1; // non multithreaded Quicksort. So only 1 thread
    ...
    public ThreadedQuicksort(boolean wantDemonstration) {
